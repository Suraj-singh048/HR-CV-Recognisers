# You need to install the following packages in your terminal/command prompt:
...
import pickle
from docx import Document  # Updated import to use python-docx
...
def pred(input_resume):
    ...
    # Convert sparse matrix to dense (optional if your model can handle sparse data)
